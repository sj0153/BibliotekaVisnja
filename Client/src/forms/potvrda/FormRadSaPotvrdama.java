...
public class FormRadSaPotvrdama extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        btnPrikaziPotvrdu.setText("PRIKAŽI POTVRDU");
    ...
    private void btnPrikaziPotvrduActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrikaziPotvrduActionPerformed
        ...
        if (selectedRow == -1) {
            ...
            try {
                JOptionPane.showMessageDialog(this, "Sistem je našao podatke o izabranoj potvrdi.", "SUCCESS", JOptionPane.INFORMATION_MESSAGE);
                ...
                JOptionPane.showMessageDialog(this, "Sistem ne može da nađe podatke o izabranoj potvrdi!", "ERROR", JOptionPane.ERROR_MESSAGE);
                ex.printStackTrace();
            }
        }
    ...
    private void btnPretraziActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPretraziActionPerformed
        ...
        if(pretraga.isEmpty()){
            JOptionPane.showMessageDialog(this, "Sistem ne može da nađe potvrde po zadatoj vrednosti.", "ERROR", JOptionPane.ERROR_MESSAGE);
        }else{
            JOptionPane.showMessageDialog(this, "Sistem je našao potvrde po zadatoj vrednosti.", "SUCCESS", JOptionPane.INFORMATION_MESSAGE);
        }
